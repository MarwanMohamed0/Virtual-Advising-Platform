<?php
// MashouraX Virtual Advising Platform - case-studies
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Case Studies - MashouraX</title>
...
<body>
    ...
    <section class="features" style="padding-top: 180px;">
        <div class="section-header">
            ...
            <p class="section-description">Real outcomes from institutions using MashouraX to improve student success.</p>
        </div>
        <div class="features-grid">
            <div class="feature-card">
                <div class="feature-icon">🎓</div>
                <h3>Metro University</h3>
                <p>Increased first-year retention by 9% with proactive outreach and 24/7 support.</p>
            </div>
            <div class="feature-card">
                <div class="feature-icon">📈</div>
                <h3>Coastal College</h3>
                <p>Cut advising response times from days to minutes, boosting student satisfaction.</p>
            </div>
            <div class="feature-card">
                <div class="feature-icon">🤝</div>
                <h3>State Tech</h3>
                <p>Streamlined degree planning and improved on-time graduation by 6%.</p>
            </div>
        </div>
    </section>
    ...
    <section class="stats">
        <div class="section-header">
            ...
            <h2 class="section-title">Case Study Statistics</h2>
            <p class="section-description">Key outcomes achieved by institutions that trust MashouraX.</p>
        </div>

        <div style="max-width:1400px;margin:0 auto;display:grid;gap:4rem;">
            <div>
                <h3 style="text-align:center;color:#fff;margin-bottom:1rem;">MIU</h3>
                <div class="stats-grid">
                    <div class="stat-item">
                        <h2>+9%</h2>
                        <p>First-year retention</p>
                    </div>
                    <div class="stat-item">
                        <h2>93%</h2>
            ...
            <div>
                <h3 style="text-align:center;color:#fff;margin-bottom:1rem;">ST. FATIMA</h3>
                <div class="stats-grid">
                    <div class="stat-item">
                        <h2>+7%</h2>
                        <p>On-time graduation</p>
                    </div>
                    <div class="stat-item">
                        <h2>95%</h2>
                        <p>24/7 help adoption</p>
                    </div>
                    <div class="stat-item">
                        <h2>−42%</h2>
                        <p>Ticket backlog</p>
                    ...
                    <div class="stat-item">
                        <h2>4×</h2>
                        <p>Advisor productivity</p>
                    </div>
                </div>
            </div>

            <div>
                <h3 style="text-align:center;color:#fff;margin-bottom:1rem;">OXFORD</h3>
                <div class="stats-grid">
                    <div class="stat-item">
                        <h2>+11%</h2>
                        <p>Engagement uplift</p>
                    </div>
                    <div class="stat-item">
                        <h2>24/7</h2>
                        <p>Always-on support</p>
                    </div>
                    <div class="stat-item">
                        <h2>82%</h2>
                        <p>Self-service resolution</p>
                    </div>
                    <div class="stat-item">
                        <h2>99.9%</h2>
                        <p>Platform uptime</p>
            ...
            <div>
                <h3 style="text-align:center;color:#fff;margin-bottom:1rem;">HARVARD</h3>
                <div class="stats-grid">
                    <div class="stat-item">
                        <h2>+6%</h2>
