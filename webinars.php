<?php
// MashouraX Virtual Advising Platform - webinars
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Webinars - MashouraX</title>
...
<body>
    ...
    <section class="features" style="padding-top: 180px;">
        <div class="section-header">
            ...
            <p class="section-description">Live and on-demand sessions on student success, AI support, and best practices.</p>
        </div>
        <div class="features-grid">
            <div class="feature-card">
                <div class="feature-icon">▶</div>
                <h3>Boost Retention with AI</h3>
                <p>How institutions use proactive support to improve outcomes at scale.</p>
            </div>
            <div class="feature-card">
                <div class="feature-icon">▶</div>
                <h3>Data-Driven Advising</h3>
                <p>Building analytics programs that identify and support at-risk students.</p>
            </div>
            <div class="feature-card">
                <div class="feature-icon">▶</div>
                <h3>Secure Integrations 101</h3>
                <p>Technical walkthrough of connecting MashouraX to your SIS/LMS systems.</p>
            </div>
        </div>
    </section>
